...
SkillWeaver reports four routing suites:
...
Cases live in `benchmarks/skill-routing-cases.json`, `benchmarks/skill-routing-holdout.json`, `benchmarks/skill-routing-fresh.json`, and `benchmarks/skill-routing-frozen-holdout.json`.
...
These snapshots are strong evidence for the active, challenge, fresh-probe regression, and frozen-holdout baseline suites, not proof of universal routing correctness.
