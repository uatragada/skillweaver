...
Safe: "V2 improves deterministic skill routing on the active acceptance suite and remains strong on the post-tuning challenge, fresh-probe regression, frozen-holdout regression, and clean-holdout V2 regression suites."
