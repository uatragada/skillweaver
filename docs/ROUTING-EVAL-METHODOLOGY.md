...
This snapshot is a regression benchmark, not a universal proof. It is strong evidence that the current concept map improves the measured suite, but future claims should add frozen holdout cases from real task logs before more tuning.
