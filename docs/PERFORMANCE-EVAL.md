...
| --- | ---: | --- |
| Scan local skill corpus | warn over 6s, investigate over 8s | 442 skills indexed in 4.518s |
| Active benchmark check | warn over 15s | 11.897s for 78 cases |
| Challenge benchmark check | warn over 10s | 7.060s for 22 cases |
| Fresh-probe benchmark check | warn over 10s | 6.719s for 18 cases |
| Frozen holdout benchmark check | warn over 10s | 6.302s for 12 cases |
| Clean holdout V2 regression benchmark check | warn over 10s | 7.102s for 14 cases |
| Clean holdout V3 benchmark check | warn over 10s | 7.271s for 18 cases |
...
| --- | ---: | ---: | --- |
| `npm test` | 1.160s | 0 | 21 tests passed |
| `npm run --silent index:skills` | 4.518s | 0 | 442 skills, 2,000/4,105 skill edges kept, 200/231 concept edges kept |
| `npm run --silent benchmark:skills:check` | 11.897s | 0 | 78 cases, report fresh |
| `npm run --silent benchmark:skills:holdout:check` | 7.060s | 0 | 22 cases, report fresh |
| `npm run --silent benchmark:skills:fresh:check` | 6.719s | 0 | 18 cases, report fresh |
| `npm run --silent benchmark:skills:frozen:check` | 6.302s | 0 | 12 cases, report fresh |
| `npm run --silent benchmark:skills:clean-v2-regression:check` | 7.102s | 0 | 14 cases, report fresh; non-gating regression evidence |
| `npm run --silent benchmark:skills:clean-v3:check` | 7.271s | 0 | 18 cases, report fresh; non-gating regression evidence |
| `npm run build` | 2.160s | 0 | production build passed |
