...
This was the first quick routing smoke benchmark. The current reproducible benchmark with an explicit output-quality rubric is [SKILL-USE-GAINS.md](SKILL-USE-GAINS.md), generated by:
